...
class StockPicking(models.Model):
        ...
        for picking in self:
            for move in picking.move_lines:
                if not move.is_subcontract:
                    continue
                for n in move.move_orig_ids:
                    production = n.production_id
    ...
    def _prepare_subcontract_mo_vals(self, subcontract_move, bom):
        ...
        vals = {
            ...
            'location_src_id': subcontract_move.picking_id.partner_id.with_context(
                force_company=subcontract_move.company_id.id).property_stock_subcontractor.id,
            'location_dest_id': 2456,  # need to be reviewed later...
    ...
    def _subcontracted_produce(self, subcontract_details):
        ...
        for move, bom in subcontract_details:
            mo = self.env['mrp.production'].with_context(force_company=move.company_id.id).create(
