...
class StockResupplyRequest(models.Model):
    ...
    debit_account_id = fields.Many2one(comodel_name="account.account", string="Debit", required=False, )
    credit_account_id = fields.Many2one(comodel_name="account.account", string="Credit", required=False, )
    ...
    def button_done(self):
        ...
        self.env['account.move'].create({
            'date': self.end_start,
            'name': 'Opening Journal Entry To ' + self.name,
